...
<body>
	...
	<div class="second">
		<a href="/ViewAppointment_d"><div class="selector1" onclick="changeBackground(this.id)"  style="background-color: #6CBCFC;" >View Appointment</div></a>
		<a href="/ViewTestResult_d"><div class="selector1" onclick="changeBackground(this.id)" >View Test Result</div></a>
		<a href="/UpdateTreatment_d"><div class="selector1" onclick="changeBackground(this.id)" >Update Treatment</div></a>
