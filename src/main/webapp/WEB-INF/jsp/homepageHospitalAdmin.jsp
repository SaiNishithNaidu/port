...
<body>
	...
	<div class="second">
		<a href="/AddFacilities_h"><div class="selector1" onclick="changeBackground(this.id)"  style="background-color: #6CBCFC;" >Add Facilities</div></a>
		<a href="/UpdateFacilities_h"><div class="selector1" onclick="changeBackground(this.id)" >Update Facilities</div></a>
		<a href="/ViewAppointment_h"><div class="selector1" onclick="changeBackground(this.id)" >View Appointment</div></a>
		<a href="/UpdateTestResult_h"><div class="selector1"onclick="changeBackground(this.id)">Update Test Result</div></a>
		<a href="/Billing_h"><div class="selector1"onclick="changeBackground(this.id)">Billing </div></a>
