...
<body>
	...
	<div class="second">
		<a href="/AddFacilities_h"><div class="selector1" onclick="changeBackground(this.id)"  >Add Facilities</div></a>
		...
		<a href="/Billing_h"><div class="selector1"onclick="changeBackground(this.id)" style="background-color: #6CBCFC;">Billing </div></a>
